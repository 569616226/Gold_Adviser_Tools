...
//                dd(in_array($permission,$role->cachedPermissions()->toArray()),array_column($role->cachedPermissions()->toArray(),'name'));
//                if(in_array($permission,array_column($role->cachedPermissions()->toArray(),'name'))){
//                    return true;
//                }
