...
class CreateRequest extends Request
{
    ...
    {
        return [
            'name' => 'required|max:20|alpha_dash|unique:meches,name',
            'address' =>'required|max:255|alpha_dash',
            'zip_code' =>'string|szie:6',
            'super'=>'required|max:20|alpha_dash',
//            'super_tel'=>'required|string|szie:11',
            'master'=>'required|max:20|alpha_dash',
//            'master_tel' => 'required|string|szie:11',
            'verify_team' => 'required|max:255|alpha_dash',
    ...
    public function messages()
    {
        return [
            ...
            'name.max' => '机构名称最多20个字符',
            'name.alpha_dash' => '机构名称仅允许字母、数字、破折号（-）以及底线（_）',
            'name.unique' => '机构名称已存在',
