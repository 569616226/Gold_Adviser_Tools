                        ...
                        <div class="pro-card">
                            <div class="am-g card-box am-margin-top">
                                ...
                                <div class="am-u-sm-10">
                                    <input id="bm_name" class="br5px" type="text" value="{{isset($mater_content) ? $mater_content->name : ''}}" placeholder="请输入清单内容名称" datatype="*" nullmsg="请输入清单内容名称"/>
                                </div>
                            </div>
                            <div class="am-g card-box am-margin-top">
                                <div class="am-u-sm-2 am-text-right" style="line-height: 2.2;">
    ...
    <script>
        ...
        var editygformobj = $("#editform").Validform({
            ...
            beforeSubmit: function (curform) {
                var url = '/admin/material/'+ $('#mater_id').val() +'/store/' + $("#editformsub").attr("name");
                AjaxJson(url, {
                    'name': $("#bm_name").val(),
