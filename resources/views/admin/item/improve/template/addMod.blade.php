        ...
        <div class="am-g">
            ...
            <div class="am-u-sm-9 am-u-md-9 am-u-lg-10" id="rightMain">
                <div class="dh-main-container">
                    <p class="title fs18">
                        <a href="{{ route('material.index',[$item->id]) }}"><i class="iconfont">&#xe604;</i></a>
                        材料清单 <span>部门管理</span>
                    </p>
                    <div class="pro-card">
                        {{--@if(Entrust::can('material.addmod',[$item->id]))--}}
                            <p><a href="#" class="am-btn am-btn-primary br5px"
                                  data-am-modal="{target: '#doc-modal-1', closeViaDimmer: 0}">添加新部门</a></p>
                        {{--@endif--}}
    ...
    <div class="am-modal am-modal-no-btn" id="doc-modal-1">
        <div class="am-modal-dialog Staff-modal-dialog" style="width: 560px;">
            ...
            <div class="am-modal-bd rights-modal am-margin-top">
                ...
                <form class="am-form am-form-horizontal" id="addmkform" style="padding:20px 40px;"
                      action="{{ route('material.submod.store',[$item->id]) }}" method="post">
                    {{ csrf_field() }}
...
@section('javascript')
    ...
    <script>
        ...
        function dffun(e) {
            ...
            var url = '/admin/item/material/delete/' + dfidsu;
