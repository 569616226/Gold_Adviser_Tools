        ...
        <div class="am-g">
            ...
            <div class="am-u-sm-9 am-u-md-9 am-u-lg-10" id="rightMain">
                <div class="dh-main-container">
                    ...
                    <div class="pro-card" style="padding: 1rem; margin-top: 30px">
                        <!--头部导航-->
                                    ...
                                    <div class="bigm-card marginT30px">
                                        <div class="am-margin-top">
                                            <h2 class="am-fl">关务风险管理
                                                ...
                                                <a href="javascript:void(0);" name="{{ $diag_mod->id }}" class="am-btn am-btn-white br5px {{ Entrust::can('task.set_task_all') ? '' : 'am-hide' }}" onclick="yifpfun(this)">一键分配</a>
                                            </h2>
                                            <div class="am-fr color888">
                                                <span>关务风险管理负责人：</span>
                                                <span>{{ $diag_mod->master ? $diag_mod->master->name : '暂无' }}</span>
                                                <a href="javascript:void(0);" name="{{ $diag_mod->id }}" class="am-btn am-btn-white br5px am-margin-left {{ Entrust::can('task.settasks') && $is_see ? '' : 'am-hide' }}" onclick="zpfun(this)">指派</a>
                                            </div>
                                            ...
                                            @foreach($diag_mod->diag_submods as $diag_submod)
                                                ...
                                                @if($item->hands->users->trade == 1 && $diag_submod->trade_type == 1 )
                                                    @continue
                                                @endif
                                                ...
                                                <div class="smallm-card  {{ ($diag_submod->task && Auth::guard('admin')->user()->id == $diag_submod->task->admin_user_id)
                                                  || Auth::guard('admin')->user()->id == $diag_mod->fid || $is_see ? '' : 'am-hide' }}">
                                                    ...
                                                    <div class="am-fr color888">
                                                        @if($diag_submod->task)
                                                            <span>子模块负责人：</span><span class="am-margin-right">{{ $diag_submod->adminUser ? $diag_submod->adminUser->name : '' }}</span>
                                                        ...
                                                        <a href="javascript:void(0);" name="{{ $diag_submod->id }}" class="am-btn am-btn-primary br5px {{ Entrust::can('task.settask')
                                                    ...
                                                    <div style="clear: both;"></div>
                                                    <!--表格（小项）-->
                                                    <table class="am-table am-table-bordered am-table-centered am-margin-top table-fwb">
                                                        <thead>
                                                        <tr class="am-active">
                                                        ...
                                                        @foreach($diag_submod->diag_subcontents as $diag_subcontent)
                                                            <tr>
                                                                ...
                                                                <td class="am-text-middle">
                                                                    <a class="{{ Entrust::can('diags.editcontent') && Auth::guard('admin')->user()->id == $diag_mod->fid || $is_see  }}" href="javascript:void(0);" name="{{ $diag_subcontent->id }}" onclick="editcontent(this)"> 编辑</a>
                                                                    <a class="{{ Entrust::can('diags.delcontent') && Auth::guard('admin')->user()->id == $diag_mod->fid || $is_see  }}" href="javascript:void(0);" name="{{ $diag_subcontent->id }}" onclick="dfcontent(this)" class="colorred"> 删除</a>
                                                                </td>
                                                            </tr>
                                                        @endforeach
                                                        </tbody>
...
//            $("#doc-modal-1").modal();
        ...
        var addcontentform = $("#addcontentform").Validform({
            ...
            beforeSubmit: function (curform) {
                ...
                var postDta = {'content':UM.getEditor('addcontent').getContent()}
