                                            ...
                                            <div class="am-margin-top">
                                                ...
                                                @foreach($diag_mod->diag_submods as $diag_submod)
                                                    ...
                                                    ||  Auth::guard('admin')->user()->id == $diag_mod->fid || $is_see ? '' : 'am-hide' }}">
                                                        ...
                                                        <div class="am-fr color888">
                                                            @if($diag_submod->task)
                                                                <span>子模块负责人：</span><span
                                                                        class="am-margin-right">{{ $diag_submod->adminUser ? $diag_submod->adminUser->name : '' }}</span>
                                                        ...
                                                        <table class="am-table am-table-bordered am-table-centered am-margin-top ">
                                                            ...
                                                            @foreach($diag_submod->diag_subcontents as $diag_subcontent)
                                                                <tr>
                                                                    ...
                                                                    <td class="am-text-middle am-text-left">{{ $diag_subcontent->describle }}</td>
                                                                    <td class="am-text-middle"><div class="stcha" name="{{ $diag_subcontent->id }}" onclick="flyjshowfun(this)">{{ $diag_subcontent->law }}</div></td>
                                                                    <td class="am-text-middle am-text-left" style="max-width: 500px;">{{ $diag_subcontent->suggest }}</td>
                                                                    <td class="am-text-middle">
                                                                        <a class="{{ Entrust::can('diags.editcontent')
                                                                        &&  Auth::guard('admin')->user()->id == $diag_mod->fid || $is_see ? '' : 'am-hide' }}" href="#" name="{{ $diag_subcontent->id }}" onclick="editcontent(this)">编辑</a>

                                                                        <a class="{{ Entrust::can('diags.delcontent')
                                                                        &&  Auth::guard('admin')->user()->id == $diag_mod->fid || $is_see ? '' : 'am-hide' }}" href="#" name="{{ $diag_subcontent->id }}" onclick="dfcontent(this)" class="colorred"> 删除</a>
                                                                    </td>
                                                                </tr>
                                                            @endforeach
                                                            </tbody>
                    ...
                    <div class="am-form-group">
                        <div class="am-u-sm-10 am-u-sm-offset-2">
                            @if(Entrust::can('task.settask'))
                                <button id="zfpbtn" type="submit" class="am-btn am-btn-primary br5px">分配</button>
                            @endif
                        </div>
                    </div>
                </form>
        ...
        <div class="am-modal-dialog modalwidth-xss" >
            ...
            <div class="am-modal-bd rights-modal am-margin-top">
                ...
                <form class="am-form am-form-horizontal" style="padding:20px 40px;" id="zpeditform">
                    ...
                    <div class="am-form-group">
                        <div class="am-u-sm-10 am-u-sm-offset-2">
                            @if(Entrust::can('task.settasks'))
                                <button id="zpbtn" type="submit" class="am-btn am-btn-primary br5px">指派</button>
                            @endif
                        </div>
                    </div>
                </form>
                ...
                <form class="am-form am-form-horizontal" style="padding:20px 40px;" id="yijianfpform">
                    ...
                    <div class="am-form-group">
                        <div class="am-u-sm-12">
                            @if(Entrust::can('task.set_task_all'))
                                <button id="yjzfpbtn" type="submit" class="am-btn am-btn-primary br5px">一键分配</button>
                            @endif
                        </div>
                    </div>
                </form>
