	...
	@parent
            ...
            <script>
                ...
                function flyjeditfun(e) {
                    ...
                    var url = '/admin/diags/'+ diag_content_id +'/law';
                    AjaxJson(url,{},function (data) {
...
//						}
                ...
                $("#flyjedit_form").Validform({
                    ...
                    beforeSubmit: function (curform) {
                        ...
                        var url = '/admin/diags/'+ diag_content_id +'/law/edit';
                        if(chk_values==""){
                            layer.msg("请选择法规内容");
                            return false;
                        };
