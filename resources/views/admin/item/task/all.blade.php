        ...
        <div class="am-g">
            ...
            <div class="am-u-sm-9 am-u-md-9 am-u-lg-10" id="rightMain">
                ...
                <div class="dh-main-container">
                    ...
                    <div class="search">
                        <form action="{{ route('all.search',[$item->id]) }}" class="am-form-inline">
                    ...
                    <table class="am-table bgfff marginT30px am-table-centered am-table-hovernew">
                        ...
                        <tr>
                            ...
                            <th class="am-text-middle" style="min-width: 80px">指派人</th>
                            <th class="am-text-middle" style="min-width: 80px">处理人</th>
        ...
        <div class="am-modal-dialog modalwidth-md">
            ...
            <div class="am-modal-bd rights-modal am-margin-top card-box">
                ...
                <div class="am-g am-margin-top-lg">
                    <a href="javascript:void(0);" style="display: none" id="mainbtn" class="am-btn am-btn-secondary br5px marginB30px amend-btn">去完成</a>
                    <a href="javascript:void(0);" style="display: none" id="surebtn" class="am-btn am-btn-secondary br5px marginB30px amend-btn">确认完成</a>
                    <a href="javascript:void(0);"  id="appectbtn" class="am-btn am-btn-success br5px marginB30px amend-btn" style="display: none;">任务验收</a>
                </div>
            </div>
        </div>
    </div>
