            ...
            <div class="am-u-sm-9 am-u-md-9 am-u-lg-10" id="rightMain">
                <div class="dh-main-container">
                    <form action="" class="am-form" id="editform">
                        <p class="title fs18">
                            <a href="{{ route('material.index',[$item->id]) }}"><i class="iconfont">&#xe604;</i></a>审核所涉及的资料 (新建清单内容)
                        </p>
                        <div class="pro-card">
                            <div class="am-g card-box marginT15px">
                                ...
                                <div class="am-u-sm-10">
                                    <input id="bm_name" class="br5px" type="text"  placeholder="请输入清单内容名称" />
                                </div>
                            </div>
                            <div class="am-g card-box marginT15px">
                                <div class="am-u-sm-2 am-text-right" style="line-height: 2.2;">
                            ...
                            <div class="am-g card-box am-margin-top am-text-center">
                                @if(Entrust::can('material.edit'))
                                    <button id="editformsub" name="" type="submit" class="am-btn am-btn-primary br5px">
                                        提交
                                    </button>
                        ...
                        <input id="mater_id" type="hidden" value="{{$material_id}}">
    ...
    <script>
        ...
        var editygformobj = $("#editform").Validform({
            ...
            beforeSubmit: function (curform) {
                ...
                openLoad();
                var url = '/admin/item/'+$('#item_id').val()+'/material/'+ $('#mater_id').val();
                AjaxJson(url, {
                    'name': $("#bm_name").val(),
