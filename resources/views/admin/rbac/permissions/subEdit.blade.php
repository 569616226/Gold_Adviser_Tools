            ...
            <div class="am-u-sm-9 am-u-md-9 am-u-lg-10" id="rightMain">
                <div class="dh-main-container">
                    ...
                    <div class=" marginT30px" style="padding-right: 10%;">
                        <form class="am-form am-form-horizontal bgfff paddt30px paddb30px" id="editform"
                              action="{{ route('permission.update',[$sub->id]) }}" method="post">
                        {{ method_field('PUT') }}
                        {{ csrf_field() }}
                        <!--一排两列-->
                            <div class="am-form-group">
                                ...
                                <div class="am-u-sm-10" style="padding-left: 0;">
                                    <div class="am-u-sm-5">
                                        ...
                                        {!! $permissionPresenter->topPermissionSelect($sub->fid) !!}

                                    </div>
                                    <label class="am-u-sm-2 am-form-label"><span class="colorred">* </span>权限路由:</label>
                                    <div class="am-u-sm-5" style="padding-right: 0;">
                                        <input name="name" class="br5px" type="text" placeholder="请输入路由" datatype="*"
                                               nullmsg="请输入路由" sucmsg=" " value="{{ $sub->name }}"/>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="am-form-group">
                                ...
                                <div class="am-u-sm-10" style="padding-left: 0;">
                                    <div class="am-u-sm-5">
                                        <input name="display_name" class="br5px" type="text" placeholder="请输入名称"
                                               datatype="*" nullmsg="请输入名称" sucmsg=" "
                                    ...
                                    {{--<div class="am-u-sm-5" style="padding-right: 0;">--}}
                                        {{--<select class="br5px" name="is_menu">--}}
                                            {{--<option value="1" {{ $sub->is_menu == 1 ? 'selected':'' }}>是</option>--}}
                                            {{--<option value="0" {{ $sub->is_menu == 0 ? '':'selected' }}>否</option>--}}
                                        {{--</select>--}}
                                    {{--</div>--}}
                                </div>
                            </div>
                            ...
                            <div class="am-form-group">
                                ...
                                <div class="am-u-sm-10">
                                    <textarea name="description" class="br5px minheight-xxs"
                                              rows="6">{{ $sub->description }}</textarea>
                                </div>
                            </div>
