            ...
            <div class="am-u-sm-9 am-u-md-9 am-u-lg-10">
                ...
                <div class="dh-main-container">
                    <form class="am-form am-form-horizontal am-margin-top"
                          action="{{ route('handover.store',[$user->id]) }}" method="post" id="xmjjd">
                        <input id="user_id" type="hidden" value="{{ $user->id }}"/>
                        <p class="title fs18"><a href="{{ route('user.index') }}"><i class="iconfont">&#xe604;</i></a>项目交接单
                        ...
                        <div class="am-margin-top">
                            ...
                            <div class="am-g" id="formbox1">
                                <div class="sreceiptCard sreceiptCard0">
                                    ...
                                    <div class="am-form-group">
                                        ...
                                        <div class="am-u-sm-10">
                                            <input name="name" class="br5px" type="text" placeholder="请输入你的项目名称"
                                                   datatype="*" nullmsg="请输入你的项目名称">
                                        </div>
                                    </div>
                                    ...
                                    <div class="am-form-group">
                                        ...
                                        <div class="am-u-sm-10">
                                            <div class="am-u-sm-5">
                                                <input name="end_time" style="background: white" type="text"
                                                       class="am-form-field" placeholder="请输入项目有效期" data-am-datepicker
                                                       readonly required datatype="*" nullmsg="请输入项目有效期"/>
                                            </div>
                                            <label class="am-u-sm-2 am-form-label"><span class="colorred">* </span>合同编号：</label>
                                            <div class="am-u-sm-5" style="padding-right: 0;">
                                                <input name="handover_no" type="text" class="am-form-field"  maxlength="20" onkeyup="replaceAndSetPos(this,/\W/g,'')" oninput="replaceAndSetPos(this,/\W/g,'')"  placeholder="请输入合同编号" datatype="sz" nullmsg="请输入合同编号" errormsg="请输入合法合同编号"/>
                                            </div>
                                        </div>
                                    </div>
                                    <!--一排两列-->
                                        ...
                                        <div class="am-u-sm-10">
                                            <div class="am-u-sm-5">
                                                <div class="am-input-group br5px widthMax">
                                                    <input name="mech_name" class="br5px" readonly="true" type="text"
                                            ...
                                            <div class="am-u-sm-5" style="padding-right: 0;">
                                                <div class="br5px widthMax">
                                                    <input name="mech_tel" class="br5px" readonly="true" type="text" placeholder="请输入客户公司电话" value="{{ $user->tel }}">
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="am-form-group">
                                        ...
                                        <div class="am-u-sm-10">
                                            <input name="mech_address" class="br5px" readonly="true" type="text"
                                                   placeholder="请输入客户公司地址" value="{{ $user->address }}">
                                        </div>
                                    </div>
                                    <div class="am-form-group">
                                        <label class="am-u-sm-2 am-form-label">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<span
                                                    class="colorred">* </span>项目描述：</label>
                                        <div class="am-u-sm-10">
                                            <script type="text/plain" id="myEditor" ></script>
                                            {{--<textarea name="description" rows="5" style="min-height: 180px !important;" datatype="*" nullmsg="请输入项目描述"></textarea>--}}
                                    ...
                                    <div>
                                        <table id="formbox2"
                                            ...
                                            <tr class="am-text-center">
                                                <td colspan="6">
                                                    <a id="addrowbtn" href="javascript:void(0);"><i class="iconfont" style="position: relative; top: 2px;">&#xe622;</i>
                                                        添加新的负责人
                                                    </a>
                                                </td>
                                            </tr>
                                            ...
                                            <tbody id="contacts">
                                                <tr class="main">
                                                    <td><input type="text" name="contacter" value="" datatype="*" nullmsg="负责人姓名不能为空"/></td>
                                                    <td><input type="text" name="busniess" value="" datatype="*" nullmsg="职务不能为空"/></td>
                                                    <td><input type="text" name="phone" value="" datatype="m" onkeyup="replaceAndSetPos(this,/[\u4E00-\u9FA5\s]/g,'')" oninput="replaceAndSetPos(this,/[\u4E00-\u9FA5\s]/g,'')" nullmsg="手机不能为空" errormsg="请输入合法手机号码"/></td>
                                                    <td><input type="text" name="wechat" value=""/></td>
                                                    <td><input type="text" name="email" value="" datatype="e" onkeyup="replaceAndSetPos(this,/[\u4E00-\u9FA5\s]/g,'')" oninput="replaceAndSetPos(this,/[\u4E00-\u9FA5\s]/g,'')" ignore="ignore" errormsg="请输入合法邮箱地址"/></td>
                                        ...
                                        <div class="am-form-group" id="formbox3">
                                            <label>营销中心建议：</label>
                                            <textarea class="minheight-xxs br5px" name="suggest"> </textarea>
                                        </div>
                                    </div>
                                </div>
                            </div>
                            <div class="am-margin-top am-text-center">
                                @if(Entrust::can('handover.create'))
                                    <a href="#" id="falshBtn" class="am-btn am-btn-secondary br5px">提交</a>
                                @endif
    ...
    <script>
        ...
        $("#xmjjd").Validform({
            ...
            beforeSubmit: function (curform) {
                ...
                //请求接口
                var url = "/admin/handover/" + user_id + "/store";
                // 跳转接口
                ...
                openLoad();
                AjaxJson(url, {'container': container, 'contacs': contacs}, function (data) {
                    if (data.status == 1) {
                        layer.msg(data.msg);
                        setTimeout(function () {
        ...
        $("#addrowbtn").click(function () {
            var strVar = "";
            strVar += '<tr class="main"><td class="am-text-middle"><input type="text" name="contacter" datatype="*" nullmsg="负责人姓名不能为空" /></td>';
            strVar += '<td class="am-text-middle"><input type="text" name="busniess" datatype="*" nullmsg="职务不能为空" /></td>';
            strVar += '<td class="am-text-middle"><input type="text" name="phone" datatype="m"   nullmsg="手机不能为空" errormsg="请输入合法手机号码" onkeyup="replaceAndSetPos(this,/[\u4E00-\u9FA5\s]/g,"")" oninput="replaceAndSetPos(this,/[\u4E00-\u9FA5\s]/g,"")" /></td>';
            strVar += '<td class="am-text-middle"><input type="text" name="wechat"/></td>';
            strVar += '<td class="am-text-middle"><input type="text" name="email" datatype="e"  ignore="ignore"  errormsg="请输入合法邮箱地址" onkeyup="replaceAndSetPos(this,/[\u4E00-\u9FA5\s]/g,"")" oninput="replaceAndSetPos(this,/[\u4E00-\u9FA5\s]/g,"")" /></td>';
