                                ...
                                <div class="paddlr20px" style="width: 100%;">
                                    <div class="bigm-card marginT30px">
                                        <div class="am-margin-top">
                                            ...
                                            @foreach($diag_mod_tem->diag_submod_tems as $diag_submod)
                                                <div class="smallm-card">
                                                    ...
                                                    <table class="am-table am-table-bordered am-table-centered am-margin-top ">
                                                        ...
                                                        @foreach($diag_submod->diag_subcontent_tems as $diag_subcontent)
                                                            <tr>
                                                                <td class="am-text-middle am-text-left" style="max-width: 500px;">{{ $diag_subcontent->content }}</td>
                                                                ...
                                                                <td class="am-text-middle">
                                                                    <a href="javascript:void(0);" name="{{ $diag_subcontent->id }}" onclick="editcontent(this)"> 编辑</a>
                                                                    <a href="javascript:void(0);" name="{{ $diag_subcontent->id }}" onclick="dfcontent(this)" class="colorred"> 删除</a>
                                                                </td>
                                                            </tr>
                                                        @endforeach
                                                        </tbody>
