                ...
                <div class="am-padding-lg">
                    <div class="text-card">
                        ...
                        <table class="am-table am-table-bordered am-table-centered am-margin-top ">
                            <thead>
                            <tr class="am-active">
                                <th class="am-text-middle" width="15%">序号</th>
                                <th class="am-text-middle" width="20%">法律条例名</th>
                                <th class="am-text-middle" width="20%">法规条例文号</th>
                                <th class="am-text-middle" width="45%">法规条例内容</th>
                            </tr>
                            </thead>
