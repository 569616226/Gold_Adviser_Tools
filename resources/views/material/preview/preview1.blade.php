            ...
            <div class="am-u-sm-9 am-u-md-9 am-u-lg-10 bgfff am-padding-bottom-lg" id="rightMain">
                <div class="dh-main-container heightMax">
                    <!--<div class="am-text-center FmText">
                        <img style="width: 50%;" src="images/kuayitong.png"/>
                    ...
                    <div class="am-margin-top-lg">
                        ...
                        <table class="am-table">
                            ...
                            <tr>
                                ...
                                <td min-width="120px" class="am-text-right color888">项目督导电话：</td>
                                <td>{{ $item->hands->meches->super_tel }}</td>
                                <td min-width="120px" class="am-text-right color888">项目督导传真：</td>
